...
- (NSURLRequest *)taskRequest
{
    NSString *urlString = [[[NTESDemoConfig sharedConfig] apiURL] stringByAppendingString:@"/room/login"];
    ...
    NSString *postData = [NSString stringWithFormat:@"refresh=%d&token=%@",false,token];
